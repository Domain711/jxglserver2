$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'course/course/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.course.id == null ? "course/course/save" : "course/course/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "course/course/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "course/course/info/"+id, function(r){
                vm.course = r.course;
            });
		},
