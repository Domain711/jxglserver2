$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '学院名称', name: 'collegename', index: 'collegename', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.college.id == null ? "college/college/save" : "college/college/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(id){
			$.get(baseURL + "college/college/info/"+id, function(r){
