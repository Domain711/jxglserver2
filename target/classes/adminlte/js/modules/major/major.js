...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.major.id == null ? "major/major/save" : "major/major/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "major/major/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "major/major/info/"+id, function(r){
                vm.major = r.major;
            });
		},
